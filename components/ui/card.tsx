...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-3xl border border-white/8 bg-white/[0.03] backdrop-blur-xl shadow-soft hud-corner scanline",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p ref={ref} className={cn("text-sm leading-6 text-white/65", className)} {...props} />
));
